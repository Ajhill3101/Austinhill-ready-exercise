...
*Describe what the data is, what it contains, where it is from, etc. Eventually this might be part of a methods section.* The raw data describes five variables; Height in centerimeters, weight in kilograms, gender in female or male or other, Age in years and Hair color. In total 14 indivuals were collected on these five variables.
