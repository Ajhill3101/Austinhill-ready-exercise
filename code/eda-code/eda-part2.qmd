...
figure_file <- here("results", "figures", "height-by-gender-boxplot.png")
ggsave(filename = figure_file, plot = p_box)
...
```{r}
p_scatter <- mydata %>%
  ggplot(aes(x = Weight, y = Age_num)) +
  geom_point()

plot(p_scatter)

figure_file <- here("results", "figures", "weight-by-age-scatter.png")
ggsave(filename = figure_file, plot = p_scatter)
